...
export default function Servers({
    ...
    guilds: { name: string; icon: string; id: string }[];
    ...
    return (
        <>
            <div className="servers">
                <div
                    className="home server tooltip-left"
                    onClick={() => {
                        setGuild("");
                        setChannel("");
                    }}
            ...
            <style jsx>{`
                ...
                .servers hr {
                    width: 32px;
                    border: 1px solid var(--clr-even-darker-grey);
                    border-radius: 1px;
                    margin-bottom: 4px;
                }
                ...
                .home svg {
                    ...
                    transition: 0.15s opacity ease-out, 0.25s color ease-out;
                }
